...
//    let currencyData: Currencies
    ...
    func getStatistics(){
        ...
        totalCost = totalQuantity*gnosisPrice
    ...
    var body: some View {
        ...
        VStack{
            Image("gnosis").resizable().frame(width:90, height:83)
            Text("Gnosis (GNO)").font(.title2).fontWeight(.semibold)
                ...
                NavigationView {
                    VStack {
                        ...
                        VStack {
                            ...
                            Text("Input Desired # of GNO:   ").fontWeight(.heavy)
                            ...
                            HStack {
                                ...
                                Text("USD: \(gnosisPrice)").font(.system(size: 13.0))
                            }
...
//                                HStack{
                        ...
                        VStack {
                            ...
                            HStack {
                                Text("GNO Quantity: ").fontWeight(.medium).foregroundColor(.black)
                                Text("\(quantityStats)").font(.system(size: 15))
                            }
                            HStack {
                                Text("Total Cost of \(quantityStats) GNO: ").fontWeight(.medium).foregroundColor(.black)
